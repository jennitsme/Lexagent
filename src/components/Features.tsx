...
import { Shield, Zap, Lock, Eye, Fingerprint, Network, Scan } from "lucide-react";
...
const features = [
  ...
  },
  {
    ...
    description: "Leverage Solana's high-speed network for instant private transactions with minimal fees. No waiting, no delays — settlement in under a second.",
    icon: Zap,
    accentIcon: Network,
    status: "OPTIMAL",
    specs: [
  ...
  },
  {
    ...
    description: "Non-custodial solution where you maintain full control of your funds through your wallet. No intermediaries, no trust required — pure cryptographic security.",
    icon: Shield,
