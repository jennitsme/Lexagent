      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div 
            ...
            className="space-y-8"
          >
            <div className="flex items-center gap-3 text-blue-600 font-mono text-sm tracking-widest uppercase">
              <Terminal className="w-4 h-4" />
              <span>What is Lexagent</span>
            </div>

            <h2 className="text-5xl md:text-7xl font-black tracking-tighter leading-[0.9] text-blue-700">
              PROGRAMMABLE<br />
              PAYMENT LAYER<br />
              <span className="text-blue-500">FOR AGENTS</span>
            </h2>

            <p className="text-blue-600 text-lg leading-relaxed max-w-lg">
            ...
            <div className="flex gap-4">
              {[
                ...
                <div 
                  key={item.label}
                  className="flex items-center gap-2 px-4 py-2 border border-sky-200/65 bg-white text-sm font-mono text-blue-600"
                >
          ...
          >
            <div className="border border-sky-200/65 bg-white p-6 font-mono text-sm relative overflow-hidden">
              <div className="flex items-center gap-2 mb-6 pb-4 border-b border-sky-200/65">
                ...
                <span className="ml-4 text-blue-500 text-xs">agent_factory.sol</span>
              </div>

              <div className="space-y-2 text-xs">
                <div>
                  <span className="text-blue-500">{'>'}</span>
                  <span className="text-blue-600"> Loading payment rules...</span>
                </div>
                <div>
                  <span className="text-blue-500">{'>'}</span>
                ...
                <div className="pt-4 border-t border-sky-200/40 mt-4 space-y-1 text-blue-500">
                  <div className="flex justify-between">
                    <span>FLOW_ID</span>
                    <span className="text-blue-700">0x7F3a...9C2d</span>
                  </div>
                  <div className="flex justify-between">
                    <span>SETTLEMENT</span>
                    <span className="text-blue-700">00:00:01</span>
                  </div>
                  <div>
                    <span className="text-blue-500 block">NETWORK</span>
                    <span className="text-blue-700">Solana</span>
                  </div>
                </div>
              </div>
            </div>
