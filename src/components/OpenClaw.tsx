      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="flex gap-4">
              {[
                ...
                <div 
                  key={item.label}
                  className="flex items-center gap-2 px-4 py-2 border border-sky-200/50 bg-white text-sm font-mono text-gray-600"
                >
          ...
          <motion.div 
            ...
            className="relative"
          >
            <div className="border border-sky-200/50 bg-white p-6 font-mono text-sm relative overflow-hidden">
              <div className="flex items-center gap-2 mb-6 pb-4 border-b border-sky-200/50">
